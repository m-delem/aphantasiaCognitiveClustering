...
in the paper "[*Unsupervised clustering reveals spatial 
and verbal cognitive profiles in aphantasia and typical imagery*](https://doi.org/10.1016/j.neuropsychologia.2025.109279)" by Delem et al. (2025). You can read the accepted version for free [here](https://doi.org/10.31219/osf.io/ucyb5_v3). All study materials are available in [this OSF
project](https://osf.io/7vsx6/), while the reproducible manuscript and complete analyses can be found in 
[the package documentation](https://m-delem.github.io/aphantasiaCognitiveClustering/) online.
