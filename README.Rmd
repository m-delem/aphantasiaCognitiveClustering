...
aphantasiaCognitiveClustering is actually a data analysis project disguised as 
an R package. It contains the code and data to reproduce the analyses presented
...
data with the scientific community, and to allow for easy reproduction of the 
...
- `correlate_vars()`: This function computes the correlation matrix of the
  ...
  significance levels. It allowed us to identify the variables that were
