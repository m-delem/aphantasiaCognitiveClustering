...
<img src="man/figures/README-plot_score_violins_groups-1.png" alt="Violin plots of the original score variables by VVIQ group.
" width="100%" />
...
<img src="man/figures/README-plot_correlations-1.png" alt="Joint plot of the correlation matrix and graph of the partial correlations between the study variables." width="100%" />
...
<img src="man/figures/README-plot_score_radars_clusters-1.png" alt="Radar charts of the clusters (left) and subclusters (right) on the reduced variables." width="100%" />
...
<a href="https://doi.org/10.17605/OSF.IO/7VSX6" target="_blank"> the OSF
project dedicated to the study</a>, which allowed to assign a permanent
DOI to the code and data. Thus, if you use this code or data in your
research, please cite the OSF project with one of the following:
