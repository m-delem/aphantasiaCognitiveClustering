...
@monzelHippocampaloccipitalConnectivityReflects2023], lack of [atemporal]{bg="transparent"} and
future imagination [@miltonBehavioralNeuralSignatures2021], increased
[face recognition difficulties]{bg="transparent"} [@miltonBehavioralNeuralSignatures2021;
...
Research that hinted at advantages of aphantasia has focused mainly on
...
fact-oriented approach. [The visual/abstract polarity in thinking styles reflected in career preferences observed by]{bg="transparent"} @zemanPhantasiaPsychologicalSignificance2020 is [reminiscent of work on the Object-Spatial-Verbal model of cognitive styles]{bg="transparent"} developed by
...
alternative strategies in visual aphantasia, has scarcely been studied. 
[Previous articles that have examined the relevance of cognitive style models for understanding aphantasia have focused on the object/spatial dissociation]{bg="transparent"} [@blazhenkovaTwoEyesBlind2019; @palermoCongenitalLackExtraordinary2022] [or the visual/verbal dissociation]{bg="transparent"} [@beranAssessingAphantasiaPrevalence2023; @takahashiDiversityAphantasiaRevealed2023] [but none so far have considered all three dimensions simultaneously.]{bg="transparent"} 
The Object-Spatial-Verbal model of cognitive styles could allow to study verbal
...
@suggateMentalImagerySkill2022], suggesting a central role for the latter. [Although similar reading habits have been observed in people with aphantasia and those with typical imagery]{bg="transparent"} [@speedRoleVisualImagery2024], [no studies have yet been conducted on reading comprehension in an ecological context in people with aphantasia.]{bg="transparent"} Such research could provide a clearer picture of the advantages or disadvantages of aphantasia in complex reading tasks involving verbal skills,
...
between individuals with aphantasia and controls [in memory tasks]{bg="transparent"} [@keoghVisualWorkingMemory2021;
@pounderOnlyMinimalDifferences2022; @knightMemoryImageryNo2022; @reederNonvisualSpatialStrategies2024], we expected
...
volunteered by contacting the team by email. [The study was carried out following the recommendations of the French Law (Loi Jardé n◦2012- 300), in accordance with the ethical standards of the institutional research committee and with the Declaration of Helsinki and its later amendments.]{bg="transparent"} Informed consent was obtained from all individual
...
analyses. [Participants who skipped a task extremely fast were removed from the data.]{bg="transparent"} Of the 1200 people who opened the link to the study, 96 completed all
...
vision*"). Scores range from 16 to 80. The total score of 32, [often]{bg="transparent"}
used as a threshold to define aphantasia [e.g., @dancePrevalenceAphantasiaImagery2022; @dawesCognitiveProfileMultisensory2020; @keoghVisualWorkingMemory2021; @speedRoleVisualImagery2024], is equivalent to a score of 2 ("*vague
...
(analogical and deductive reasoning abilities). The Raven matrices contain 60
...
*bayestestR* [@bayestestR2019], [using default weakly informative priors]{bg="transparent"}. The R package *emmeans* [@R-emmeans] was used for marginal
...
cors   <- readRDS(here::here("inst/manuscript/correlations.rds"))
...
`r n_men` males, `r n_oth` another gender). [We identified aphantasia as a score below 32 on the VVIQ, a threshold often used in the literature]{bg="transparent"} [e.g., @dancePrevalenceAphantasiaImagery2022; @dawesCognitiveProfileMultisensory2020; @keoghVisualWorkingMemory2021; @speedRoleVisualImagery2024]. There were `r n_aph` individuals with
...
participant groups as categorical predictors and age as a continuous covariate to control for the potential influence of the latter. Contrast analyses
...
Intervals are reported in Table @fig-g-violins along with the $log(BF_{10})$
...
for them considering our data. We studied this hypothesis by searching for
...
subscales related to visual imagery, i.e., the VVIQ, the OSIVQ-[Object]{bg="transparent"} and Psi-Q
...
aphantasia across larger samples. However, our findings [show]{bg="transparent"} another relevant
dimension by linking these [aphantasia]{bg="transparent"} profiles to different cognitive styles:
...
samples. [Although the use of a trans-categorical approach (clustering on a mixed sample of people with aphantasia or typical imagery) allowed us to reveal relevant dimensions of cognitive profiles, there may be more nuanced patterns in aphantasia that this study was unable to capture due to the sample size.]{bg="transparent"} Moreover, the tasks used to assess mental imagery and reasoning were
...
tasks specifically designed to disentangle these dimensions. [For instance, in relation to the OSIVQ, the Degraded Pictures Task]{bg="transparent"} [@kozhevnikovSpatialObjectVisualizers2005; @blazhenkovaNewObjectspatialverbalCognitive2009; @kozhevnikovTradeoffObjectSpatial2010], [the Paper Folding Test]{bg="transparent"} [@kozhevnikovSpatialObjectVisualizers2005; @blazhenkovaNewObjectspatialverbalCognitive2009; @haciomerogluObjectSpatialVisualizationVerbal2016; @hofflerMoreEvidenceThree2017] [and vocabulary tasks]{bg="transparent"} [@blazhenkovaNewObjectspatialverbalCognitive2009; @bledValidationFrenchVersion2021] [have been shown to correlate with object, spatial and verbal scores, respectively.]{bg="transparent"} Furthermore, it
remains to be seen whether the profiles identified here can be validated with
other physiological and neural phenomena, such as differences in brain activity
