---
title: "aphantasiaCognitiveClustering: Data analysis report"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Complete analysis with aphantasiaCognitiveClustering}
...
The main dataset used for the analysis is included in the package in the
...
[BayesFactors](https://cran.r-project.org/package=BayesFactor) package.
...
The `cluster_selected_vars()` function is computes the clustering on the 
...
plot_score_radars(df_merged_long, Cluster, r_off = 6, l_off = 6) + 
  plot_score_radars(df_merged_long, Subcluster, r_off = 6, l_off = 6)
```
